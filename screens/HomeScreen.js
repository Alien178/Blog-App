...
export default class HomeScreen extends React.Component {
  ...
  getArticle = () => {
    const url = "http://d90cf785caef.ngrok.io/get-article";
  ...
  likedArticle = () => {
    const url = "http://d90cf785caef.ngrok.io/liked-article";
    axios
      .post(url)
      .then((response) => {
        this.getArticle();
  ...
  unlikedArticle = () => {
    const url = "http://d90cf785caef.ngrok.io/unliked-article";
    axios
      .post(url)
      .then((response) => {
        this.getArticle();
